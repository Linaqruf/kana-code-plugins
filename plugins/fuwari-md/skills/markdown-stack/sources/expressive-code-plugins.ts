/**
 * Custom Expressive Code plugins for enhanced code block rendering.
 *
 * Includes:
 * - Custom copy button with animated feedback
 * - Language badge display
 *
 * @example
 * ```js
 * import { pluginCustomCopyButton, pluginLanguageBadge } from './expressive-code-plugins';
...
/**
 * Custom copy button plugin with animated success feedback.
 * Adds a copy button to each code block with copy/success icons.
 */
...
/**
 * Language badge plugin that shows the code language in the corner.
 * Based on: https://github.com/expressive-code/expressive-code/issues/153
 */
